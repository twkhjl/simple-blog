const en = {
  ...
  public: {
    ...
    comments: {
      eyebrow: 'Discussion',
      title: 'Comments',
      copy: 'Leave a public comment. New comments appear after admin approval.',
      loading: 'Loading comments...',
      empty: 'No approved comments yet.',
      loadError: 'Failed to load comments',
      submit: 'Submit Comment',
      submitting: 'Submitting...',
      submitSuccess: 'Your comment has been submitted and is awaiting moderation.',
      submitError: 'Failed to send comment',
      rateLimited: 'You are sending comments too frequently. Please try again later.',
      replyingTo: 'Replying to {author}',
      required: 'Name, email, and comment are required.',
  ...
  admin: {
    ...
    comments: {
      eyebrow: 'Moderation',
      title: 'Comments',
      copy: 'Review public article comments, approve them, or hide and delete them.',
      search: 'Search',
      searchPlaceholder: 'Search by author, email, or comment',
      statusFilter: 'Status',
      statusAll: 'All',
      statusPending: 'Pending',
      ...
      emptyCopy: 'New article comments will appear here.',
      loadError: 'Failed to load comments',
      loadDetailError: 'Failed to load comment detail',
      updateError: 'Failed to update comment status',
      deleteError: 'Failed to delete comment',
      deleteWarning: 'Deleting this comment will also remove all nested replies.',
